    ...
    return (
        <>
            ...
            >
                ...
                <div className="relative w-5 h-5 md:w-6 md:h-6" aria-hidden="true">
                    <span
          ...
          `}
                >
                    ...
                    {/* 내비게이션 */}
                    <nav id="main-navigation" aria-label="주요 네비게이션">
                        <ul
                            className={`
              ...
              `}
                    ...
                    <div className="mt-6 pt-4 border-t border-slate-600/30 text-center md:hidden">
                        <h1 className="text-xs text-slate-400">이상철 • Frontend Developer</h1>
                    </div>
                </div>
            </header>
        </>
